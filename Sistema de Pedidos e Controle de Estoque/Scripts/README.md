...
Trigger	Função
TRG_LOG_ALTERACOES_BD	Registra INSERT, UPDATE e DELETE
TRG_VALIDA_ESTOQUE	Impede venda sem estoque disponível
TRG_LOG_ALTR_BI	Geração automática de IDs de log
👁️ Views Criadas
VIEW_CLIENTE
...
RN01	Cliente pode ser PF ou PJ	Especialização
RN02	Pedido deve ter cliente e vendedor	FK obrigatória
RN03	Pedido pode ter vários produtos	ITEM_PRODUTO
RN04	Não vender sem estoque	Trigger
RN05	Histórico de preço por item	Preço no ITEM_PRODUTO
RN06	CPF e CNPJ únicos	UNIQUE
RN07	Total do pedido calculado	UPDATE + agregação
RN08	Logs automáticos	Trigger
